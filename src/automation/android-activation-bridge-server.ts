        ...
        try {
            ...
            if (!proxySessionPreparation.success || !proxySessionPreparation.ruleSessionHandleAvailable || !proxySessionPreparation.session) {
                ...
                res.status(500).send({
                    ...
                    remoteStartAttempted: proxySessionPreparation.remoteStartAttempted ?? false,
                    registryEntryFound: proxySessionPreparation.registryEntryFound ?? false,
                    registryKeys: proxySessionPreparation.registryKeys ?? [],
